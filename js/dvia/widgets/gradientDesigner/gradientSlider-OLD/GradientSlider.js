define([
	...
	"dijit/_Container",
	"dojo/text!./html/gradientSlider.html"
...
var HorizontalSlider = declare("dvia.widgets.gradientDesigner.gradientSlider.GradientSlider", [_FormValueWidget, _Container], {
	// summary:
	//		A form widget that allows one to select a value with a horizontally draggable handle
